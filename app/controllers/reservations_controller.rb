class ReservationsController < ApplicationController
  ...
  def create
    ...
    @reservation.reservation_time_start = DateTime.new(params[:reservation]["reservation_time_start(1i)"].to_i,
    ...
    @reservation.reservation_time_end = DateTime.new(params[:reservation]["reservation_time_end(1i)"].to_i,
